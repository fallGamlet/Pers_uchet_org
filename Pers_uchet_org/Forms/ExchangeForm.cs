...
namespace Pers_uchet_org
{
    public partial class ExchangeForm : Form
    {
        ...
        private void viewdataButton_Click(object sender, EventArgs e)
        {
            ...
            string path = @"d:\Bins Б000044.2012\"; //mapstyle.bin svodstyle.bin   szvopisstyle.bin   szvstyle.bin
            
            int i;
            byte[] bData = File.ReadAllBytes(path + "szvstyle.bin");
            char[] buf = { '0', '0' };
            ...
            File.WriteAllText(path + "szvstyle.txt", Encoding.GetEncoding(1251).GetString(res));           
            ...
            //String filename = "MyCompoundFile.cfs";

            //CompoundFile cf = new CompoundFile(filename);
            //CFStream foundStream = cf.RootStorage.GetStream("MyStream");

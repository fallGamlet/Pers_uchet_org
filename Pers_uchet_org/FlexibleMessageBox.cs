    ...
    */
    public class FlexibleMessageBox
    {
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private static readonly String[] BUTTON_TEXTS_RUSSIAN = { "OK", "Отмена", "Да", "Нет", "Прервать", "Повтор", "Пропустить" };
            ...
            private FlexibleMessageBoxForm()
            {
                ...
                //this._isCultureGerman = CultureInfo.InstalledUICulture.TwoLetterISOLanguageName.Contains("ru");
            }
            ...
            private string GetButtonText(BUTTON_TEXT buttonTextIndex)
            {
                ...
                {
                    case "ru":
                        return BUTTON_TEXTS_RUSSIAN[Convert.ToInt32(buttonTextIndex)];
                    case "en":
